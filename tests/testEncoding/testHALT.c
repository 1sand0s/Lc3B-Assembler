...
int main(void)
{
    ...
    Suite *s1 = suite_create("Test HALT");

    /* Create test cases to add to test suite */
    TCase *tc1_0 = tcase_create("HALT CORRECT");
    TCase *tc1_1 = tcase_create("HALT INCORRECT ADDRESS LESS THAN 0");
    TCase *tc1_2 = tcase_create("HALT INCORRECT ADDRESS GREATER THAN 65535");
    ...
    tcase_add_test(tc1_0, testEncoding_HALT_CORRECT_);
    tcase_add_test(tc1_1, testEncoding_HALT_INCORRECT_LESS_THAN_0_);
    tcase_add_test(tc1_2, testEncoding_HALT_INCORRECT_GREATER_THAN_65535_);
